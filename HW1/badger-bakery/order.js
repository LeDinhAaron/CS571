...
let subtotal = 0.00;
	for (let item of ITEMS) {
        ...
        // Calculate the cost for the current item and add it to the subtotal
...
function calculateSalesTax() {
	...
	const salesTaxRate = parseFloat(getSalesTaxRateForState(state));
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	const salesTaxRate = getSalesTaxRateForState(document.getElementById("state-tax").value);
	const subtotal = parseFloat(calculateSubtotal());
