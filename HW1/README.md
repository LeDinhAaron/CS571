...
![Badger Bakery Thoughts](figures/badgerBakeryEmpathize.drawio.png)
...
![Badger Bakery Sketch](figures/BadgerBakerySketch.png)
-All of the information located on a single scrollable interface
-More pictures, especially of the pastries, perhaps popping up while scrolling
-A picture of a worker baking the pastries to create a more welcoming/lively atmosphere
-Shopping cart system where users can "add" pastries to a shopping cart
-Leaving customer reviews
-Single button that calculates total price based on state
